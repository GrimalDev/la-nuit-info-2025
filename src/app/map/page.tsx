            ...
            <div className="col-12 col-xl-9">
              <div className="card card-tertiary">
                <div className="card-header text-center">
                  <span>🗺️ Carte des dons par région</span>
                </div>
                <div className="card-body text-center">
                  <h5 className="mb-4">Visualisez l'impact de notre initiative</h5>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-6 mb-4">
              <div className="card">
                <div className="card-header text-center">
                  📊 {selectedRegion ? selectedRegion.name : "Statistiques nationales"}
                </div>
            ...
            <div className="col-12 col-lg-10">
              <div className="card">
                <div className="card-header">
                  <span>📍 France - Cliquez sur une région</span>
                </div>
                <div className="card-body">
                  <svg
                    viewBox="0 0 600 600"
                  ...
                  <div className="card-body">
                    <div className="row">
                      <div className="col-12 col-md-6 mb-3">
                        <div className="card">
                          <div className="card-body text-center">
                            <h4 className="display-4 mb-2">{selectedRegion.donations}</h4>
                            <p className="mb-0 small">💻 Dons de matériel</p>
                          </div>
                        </div>
                      </div>
                      <div className="col-12 col-md-6 mb-3">
                        <div className="card">
                          <div className="card-body text-center">
                            <h4 className="display-4 mb-2">{selectedRegion.schools}</h4>
                            <p className="mb-0 small">🏫 Écoles partenaires</p>
                          </div>
                        </div>
                      </div>
                    </div>
