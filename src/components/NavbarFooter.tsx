        ...
        <>
            <nav className="navbar navbar-main navbar-expand-lg navbar-dark justify-content-between navbar-footer">
                <ul className="navbar-nav navbar-nav-hover flex-row align-items-center">
                    ...
                    <li className="nav-item">
                        <Link href="/donate" className="nav-link" role="button">
                    ...
                    <li className="nav-item">
                        <Link href="/map" className="nav-link" role="button">
                            <span className="nav-link-inner-text">
                                🗺️ Carte
                            </span>
                        </Link>
                    ...
                    <li className="nav-item">
                        <Link href="/about" className="nav-link" role="button">
                            <span className="nav-link-inner-text">
                                📕 À propos
                            </span>
                        </Link>
